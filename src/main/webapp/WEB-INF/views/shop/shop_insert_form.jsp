        ...
        new daum.Postcode({
          oncomplete: function (data) {
            ...
            if (data.userSelectedType === "R") {
              // If the user selects the road name address (R)
              addr = data.roadAddress;
            } else {
              // If the user selects the Jibun address (J)
    ...
    <script>
      $(document).ready(function () {
        ...
        nhn.husky.EZCreator.createInIFrame({
          ...
          sSkinURI:
            "${pageContext.request.contextPath}/resources/smarteditor2/SmartEditor2Skin.html",
          htParams: {
            bUseToolbar: true,
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <div class="form-floating">
                            <button
                              type="button"
                              class="form-control button_style"
                    ...
                    <div class="col-md-6">
                      <div class="form-floating">
                        <input
                          ...
                          class="form-control"
                          placeholder="영업마감시간"
                          name="shop_close_hour"
                          value="00:00"
                        />
                        <label
                          >영업 마감 시간 (미입력시 항상 영업중으로
                          표기됩니다.)</label
                        >
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-floating">
                        ...
                        >
                          ...
                          <option class="form-control" value="Monday">
                            월요일
                          </option>
                          <option class="form-control" value="Tuesday">
                            화요일
                          </option>
                          <option class="form-control" value="Wednesday">
                            수요일
                          </option>
                          <option class="form-control" value="Thursday">
                            목요일
                          </option>
                          <option class="form-control" value="Friday">
                            금요일
                          </option>
                          <option class="form-control" value="Saturday">
                            토요일
                          </option>
                          <option class="form-control" value="Sunday">
                            일요일
                          </option>
                        </select>
                        <label>휴무일 </label>
                    ...
                    <div class="col-md-12">
                      <div class="form-floating">
                        <select
                          ...
                          name="food_category"
                        >
                          <option class="form-control" value="pork_trotters">
                            족발·보쌈
                          </option>
                          <option class="form-control" value="pizza">
                            피자
                          </option>
                          <option class="form-control" value="chicken">
                            치킨
                          </option>
                          <option class="form-control" value="japanese_food">
                            돈까스·회·일식
                          </option>
                          <option class="form-control" value="korea_food">
                            한식
                          </option>
                          <option class="form-control" value="chinese_food">
                            중식
                          </option>
                          <option class="form-control" value="asian_food">
                            아시안
                          </option>
                          <option class="form-control" value="porridge_noodle">
                            백반·죽·국수
                          </option>
                          <option class="form-control" value="snack_food">
                            분식
                          </option>
                          <option class="form-control" value="desserts">
                            카페·디저트
                          </option>
                          <option class="form-control" value="fast_food">
                            패스트푸드
                          </option>
                        </select>
                        <label>음식 카테고리 </label>
