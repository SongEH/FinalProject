...
// public class X_MemberController {
...
// X_MemberVo vo = member_mapper.selectOneFromId(mem_id);
...
// public String insert(X_MemberVo vo) {
...
// X_MemberVo user = member_mapper.selectOneFromId(mem_id);
...
// X_MemberVo user = (X_MemberVo) session.getAttribute("user");
...
// X_MemberVo vo = member_mapper.selectOneFromIdx(mem_idx);
...
// public String modify(X_MemberVo vo) {
...
// X_MemberVo loginUser = (X_MemberVo) session.getAttribute("user");

// // 현재수정정보가 로그인한 유저 본인인경우
// if (loginUser.getMem_idx() == vo.getMem_idx()) {

// // 로그인상태정보
// X_MemberVo user = member_mapper.selectOneFromIdx(vo.getMem_idx());
