...
<head>
    ...
    <script type="text/javascript">
        function send(f){
            ...
            f.action = "${pageContext.request.contextPath}/member_inquiries/answer_insert.do";
            f.submit();
        }
    </script>
</head>
<body>
    ...
    <main id="main" class="main">
        ...
        <nav>
            ...
            <li class="breadcrumb-item active">회원문의사항</li>
            </ol>
        </nav>
        ...
        <form action="${pageContext.request.contextPath}/member_inquiries/answer_insert_form.do" method="post">
            
            <input type="hidden" name="m_inquiries_id" value="${param.m_inquiries_id}">
            <input type="hidden" name="m_answer_id" value="${answer.m_answer_id}">
            <div class="form-group">
                <label for="m_answer_content">내용</label>
                <textarea id="m_answer_content" name="m_answer_content" rows="5" required></textarea>
            </div>
            <div class="form-group">
