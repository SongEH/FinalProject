...
import com.githrd.demo_final_project.dao.MenuMapper;
import com.githrd.demo_final_project.util.MyCommon;
import com.githrd.demo_final_project.util.Paging;
...
public class MenuController {
	...
	public Map<String, String> photo_upload(int p_idx,
		...
		// p_idx에 저장된 이전화일 삭제
		MenuVo vo = menu_mapper.selectOne(p_idx);
