    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/notice/modify_form.do" method="post">
            ...
            <div class="form-group">
                ...
                <input id="notice_content" name="notice_content" rows="5" value="${vo.notice_content}" required>
            </div>
            <div class="form-group">
                <button type="button" class="btn btn-primary" onclick="send(this.form);">
                    수정
                </button>
                <button type="button" class="btn btn-primary" onclick="location.href='/notice/detail.do'">
                    취소
                </button>
            </div>
        </form>
