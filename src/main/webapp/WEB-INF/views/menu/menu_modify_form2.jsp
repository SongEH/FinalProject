		  ...
		  <div class="card">
			<div class="card-body">
			  ...
			  <form class="row g-3" method="POST" enctype="multipart/form-data">
				...
				<div class="col-md-12">
				  <div class="form-floating">
					<input type="text" class="form-control" placeholder="가격" name="menu_price" value="${ vo.menu_price }">
					<label>가격</label>
				  </div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-floating mb-3">
						<select class="form-select" id="floatingSelect" aria-label="State" name="menu_category">
							...
							<option value="1" ${vo.menu_category == '1' ? 'selected' : ''}>임시카테고리1</option>
							<option value="2" ${vo.menu_category == '2' ? 'selected' : ''}>임시카테고리2</option>
							<!-- 추가 옵션은 여기에 추가 -->
						</select>
