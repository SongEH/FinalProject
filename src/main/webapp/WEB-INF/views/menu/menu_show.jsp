											...
											<div class="card-body">
												...
												<form class="row g-3" method="POST" enctype="multipart/form-data">
													...
													<div class="col-md-12">
														<div class="form-floating">
															<input type="text" class="form-control" placeholder="메뉴명"
																name="menu_name" value="${ vo.menu_name }" disabled>
															<label>메뉴명</label>
														</div>
													</div>
													...
													<div class="col-md-12">
														<div class="form-floating">
															<textarea class="form-control" placeholder="메뉴설명"
																name="menu_content" tyle="height: 100px;"
													...
													<div class="col-md-12">
														<div class="form-floating">
															<input type="text" class="form-control" placeholder="가격"
																name="menu_price" value="${ vo.menu_price }" disabled>
															<label>가격</label>
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-floating mb-3">
															<select class="form-select" id="floatingSelect"
																aria-label="State" name="menu_category" disabled>
																<!-- 옵션 목록 -->
													...
													<div class="col-12">
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																id="menu_popularity_view" value="1"
													...
													<div class="col-12">
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																id="menu_hidden_view" value="2" ${vo.menu_hidden==1
																? 'checked' : '' } disabled>
													...
													<div class="col-12">
														<div class="form-check">
															<input class="form-check-input" type="checkbox"
																id="menu_soldout_view" value="3" ${vo.menu_soldout==1
																? 'checked' : '' } disabled>
